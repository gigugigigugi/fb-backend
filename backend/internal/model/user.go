...
type User struct {
	...
	Phone         *string        `gorm:"size:20;uniqueIndex" json:"phone,omitempty"`      // 用户手机号（E.164 格式），用于短信通知与校验
	...
	EmailVerified bool           `gorm:"default:false" json:"email_verified"`             // 邮箱是否完成验证码验证
	PhoneVerified bool           `gorm:"default:false" json:"phone_verified"`             // 手机号是否完成验证码验证
